...
file_input ='data/' + filename + '_corrected.xlsx'
output = 'data/' +'dependencies_' + filename + '_corrected.xlsx'

metabolites_in = ['ACE','BUT','GLYC_ext','GLC','ADP','ATP','H','H2O','Pi','NADPH','NADP','cNADP','cNADPH', 'CO2','O2','SO4','NH4','Mg2','NAD','NADH','ACP','Light','THF','CoA','FAD']
